  ...
  return (
    <motion.div
      ...
      <input type={type} value={value} onChange={onChange} placeholder={label}
        ...
        style={{flex:1,background:"transparent",border:"none",outline:"none",fontSize:"14px",fontFamily:"'DM Sans',sans-serif",fontWeight:400,color:"#d4922e",letterSpacing:type==="password"&&value?"0.2em":"0.02em"}}
      />
    </motion.div>
  );
};
...
const PasswordRules = ({ password }) => {
  ...
  return (
    <div style={{margin:"-4px 0 8px 2px"}}>
      ...
      {rules.map((r,i)=>(
        <div key={i} style={{display:"flex",alignItems:"center",gap:"6px",fontFamily:"'DM Sans',sans-serif",fontSize:"11px",marginBottom:"3px",color:r.test?"rgba(100,200,80,0.8)":"rgba(180,110,15,0.45)"}}>
        ...
        {!sent?(
          <>
            ...
            <input type="email" placeholder="Email Address" value={fpEmail} onChange={e=>setFpEmail(e.target.value)} onKeyDown={e=>e.key==="Enter"&&handleSend()}
              style={{width:"100%",padding:"14px 18px",borderRadius:"50px",background:"rgba(5,2,0,0.92)",border:"1px solid rgba(100,55,5,0.30)",color:"#d4922e",fontFamily:"'DM Sans',sans-serif",fontSize:"14px",outline:"none",boxSizing:"border-box",marginBottom:"16px"}}/>
          ...
          <>
            <div style={{textAlign:"center",padding:"10px 0"}}>
              ...
              <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:"13px",color:"rgba(180,110,15,0.7)",lineHeight:1.5}}>Reset link sent to<br/><span style={{color:"#d4922e",fontWeight:600}}>{fpEmail}</span></p>
            </div>
    ...
    <>
      ...
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        input:-webkit-autofill{-webkit-box-shadow:0 0 0 40px #0d0600 inset!important;-webkit-text-fill-color:#c8850a!important}
                ...
                <motion.div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",gap:"12px",backfaceVisibility:"hidden",opacity:frontOpacity,pointerEvents:mode==="login"?"auto":"none"}}>
                  ...
                  <div style={{display:"flex",justifyContent:"flex-end"}}>
                    <motion.button onClick={()=>setShowForgot(true)} whileHover={{scale:1.05}} whileTap={{scale:0.97}}
                      style={{padding:"7px 16px",borderRadius:"50px",background:"transparent",border:"1px solid rgba(140,80,5,0.40)",fontSize:"10px",letterSpacing:"0.14em",fontFamily:"'DM Sans',sans-serif",fontWeight:600,color:AMBER_DIM,cursor:"pointer",textTransform:"uppercase"}}>
                      Forgot Password?
                    </motion.button>
                  </div>
